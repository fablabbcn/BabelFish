    ...
    this.pluginHandler = new function () {
            ...
            window.PluginLoggingInterval = setInterval(function () {
	            ...
	            try {
	                ...
	                if ((typeof selfPh.codebenderPlugin.availablePorts == 'undefined') &&
		                ...
		                var ports = {};
		                $('#cb_cf_ports').find('> option').each(function (index) {
        ...
        this.connect = function () {
	        ...
	        if (typeof window.isWindowsAndChrome != 'undefined' && window.isWindowsAndChrome()) {
				$serialHud.append(document.createTextNode('Warning! Because of a known bug on Chrome, you should press disconnect before physically disconnect your device. Or else the connection with the serial monitor will stay open.'));
	        }
