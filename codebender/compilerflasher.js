compilerflasher = function(lf){
    ...
    this.pluginHandler = new function(){
        ...
        this.clickedPort = function()
        {
            ...
            url = "http\x3A\x2F\x2Ftsiknas.codebender.cc\x2Futilities\x2Flogdb\x2F43\x2FCLICK_PORT_META";
        ...
        this.logPorts = function () {
            ...
            if (oldPort != newPort) {
                url = "http\x3A\x2F\x2Ftsiknas.codebender.cc\x2Futilities\x2Flogdb\x2F38\x2FSAVEPORTMETA";
        ...
        this.validateVersion = function(version)
        {
            ...
            if (this.comparePluginVersions(this.parseVersionString(this.codebender_plugin.version), this.parseVersionString(minimumVersion)) < 0)
            {
                ...
                this.owner.setOperationOutput(alert);
                this.owner.eventManager.fire('plugin_notification', alert);
                url = "http\x3A\x2F\x2Ftsiknas.codebender.cc\x2Futilities\x2Flogdb\x2F27\x2FPLUGIN_META";
        ...
        this.initializePluginPortsLogger = function()
        {
            ...
            window.PluginLoggingInterval = setInterval(function(){
                try
                {
                    if(typeof(pl.codebender_plugin.probeUSB) === "undefined")
                    {
                        url = "http\x3A\x2F\x2Ftsiknas.codebender.cc\x2Futilities\x2Flogdb\x2F34\x2FPLUGIN_META";
                    ...
                    else
                    {
                                ...
                                ||(oldPortsAvail.length > portsAvail.length || (oldPortsAvail.length == 1 && portsAvail.length == 1 && oldPortsAvail[0] != "" && portsAvail[0] == ""))))
                        {
                            ...
                            var url = "http\x3A\x2F\x2Ftsiknas.codebender.cc\x2Futilities\x2Flogdb\x2F36\x2FPLUGIN_META";
                            ...
                            pl.codebender_plugin.getPorts(function (serialPortsAvail) {
                                if (oldSerialPortsAvail != serialPortsAvail)
                                {
                                    ...
                                    pl.codebender_plugin.probeUSB(function (result) {
                                        ...
                                        $.get(url);
                                        var url = "http\x3A\x2F\x2Ftsiknas.codebender.cc\x2Futilities\x2Flogdb\x2F74\x2FPLUGIN_META";
        ...
        this.browserSpecificPluginInstall = function(alert)
        {
            ...
            {
                alert+= '<a target="_blank" href = "http\x3A\x2F\x2Ftsiknas.codebender.cc\x2Fstatic\x2Fplugin" >Learn more.</a>';
            }
            else
            {
                if(Browsers.isBrowser("Chrome") || Browsers.isBrowser("Chromium"))
                {
                    if(Browsers.isOs('Windows','>=','6.2'))
                        alert+= '<a onclick=\'compilerflasher.pluginHandler.addTo("Windows", "\x2F\x2Ftsiknas.codebender.cc\x2FCodebendercc.msi")\' id="msi-download-url" href = "javascript:void(0);" >Add to Windows.</a>';
                    else
                ...
                {
                    alert+= '<a onclick=\'compilerflasher.pluginHandler.addTo("Firefox", "\x2F\x2Ftsiknas.codebender.cc\x2Fcodebender.xpi")\' id="xpi-download-url" href = "javascript:void(0);" >Add to Firefox.</a>';
                }
            }
        ...
        {
            url = "http\x3A\x2F\x2Ftsiknas.codebender.cc\x2Futilities\x2Flogdb\x2F45\x2FADD_TO_META";
...
//        alertElement += "<button type='button' class='close' data-dismiss='alert'>x</button>";
        ...
        this.connect = function() {
            ...
            if (this.connected == false) {
                var url = "http\x3A\x2F\x2Ftsiknas.codebender.cc\x2Futilities\x2Flogdb\x2F18\x2FSERIAL_MONITOR_META";
                ...
                if ($("#cb_cf_ports").val() != null && $("#cb_cf_ports").val() != "") {
                    ...
                    pl.codebender_plugin.serialRead(
                            ...
                            function (from, line){
                                var url = "http\x3A\x2F\x2Ftsiknas.codebender.cc\x2Futilities\x2Flogdb\x2F69\x2FPLUGIN_SERIAL_MONITOR_RETVAL_META";
        ...
        this.disconnect = function(notified) {
            ...
            if (this.connected == true) {
                if(notified == false)
                {
                    var url = "http\x3A\x2F\x2Ftsiknas.codebender.cc\x2Futilities\x2Flogdb\x2F59\x2FSERIAL_MONITOR_DISC_META";
        ...
        this.plugin_error_logger = function(from, msg, status){
            ...
            {
                var url = "http\x3A\x2F\x2Ftsiknas.codebender.cc\x2Futilities\x2Flogdb\x2F34\x2FPLUGIN_ERROR_META";
            ...
            {
                var url = "http\x3A\x2F\x2Ftsiknas.codebender.cc\x2Futilities\x2Flogdb\x2F55\x2FPLUGIN_WARNING_META";
    ...
    if($("select#cb_cf_boards").length > 0)
    {
        ...
        $.getJSON("http\x3A\x2F\x2Ftsiknas.codebender.cc\x2Fboard\x2Flistboards", function(data){boardsListCallback(data)});
    ...
    if($("select#cb_cf_programmers").length > 0)
    {
        ...
        $.getJSON("http\x3A\x2F\x2Ftsiknas.codebender.cc\x2Fboard\x2Fprogrammers", function (data)
        {
    ...
    this.saveBoard = function() {
        ...
        url = "http\x3A\x2F\x2Ftsiknas.codebender.cc\x2Futilities\x2Flogdb\x2F37\x2FSAVEBOARDMETA";
    ...
    this.saveProgrammer = function() {
        ...
        url = "http\x3A\x2F\x2Ftsiknas.codebender.cc\x2Futilities\x2Flogdb\x2F39\x2FSAVEPROGRAMMERMETA";
    ...
    this.clickedBoard = function()
    {
        ...
        url = "http\x3A\x2F\x2Ftsiknas.codebender.cc\x2Futilities\x2Flogdb\x2F42\x2FCLICK_BOARD_META";
    ...
    this.clickedProgrammer = function()
    {
        ...
        url = "http\x3A\x2F\x2Ftsiknas.codebender.cc\x2Futilities\x2Flogdb\x2F44\x2FCLICK_PROGRAMMER_META";
  ...
  this.flash_callback = function(from, progress) {
        ...
        var url = "http\x3A\x2F\x2Ftsiknas.codebender.cc\x2Futilities\x2Fflash\x2FERROR_CODE";
    ...
    this.usbflash = function()
    {
        ...
        url = "http\x3A\x2F\x2Ftsiknas.codebender.cc\x2Futilities\x2Flogdb\x2F40\x2FRUN_BUTTON_META";
    ...
    {
        url = "http\x3A\x2F\x2Ftsiknas.codebender.cc\x2Futilities\x2Flogdb\x2F41\x2FRUN_WITH_PROG_BUTTON_META";
    ...
    this.verify =  function() {
        ...
        var board = $("#cb_cf_boards option:selected").text();
        url = "http\x3A\x2F\x2Ftsiknas.codebender.cc\x2Futilities\x2Flogdb\x2F47\x2FVERIFY_META";
    ...
    this.burn_bootloader = function() {
        ...
        {
            var url = "http\x3A\x2F\x2Ftsiknas.codebender.cc\x2Futilities\x2Flogdb\x2F25\x2FUPLOAD_BOOTLOADER_META";
