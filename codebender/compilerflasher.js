if (window.codebenderDeveloperModea)
...
compilerflasher = function(lf){
  ...
  this.pluginHandler = new function(){
    ...
    if (window.CodebenderPlugin !== undefined) {
      ...
      this.codebender_plugin = function () {};
    }
    ...
    this.clickedPort = function()
    {
      ...
      url = "http\x3A\x2F\x2Fstaging.codebender.cc\x2Futilities\x2Flogdb\x2F43\x2FCLICK_PORT_META";
    ...
    this.logPorts = function () {
      ...
      if (oldPort != newPort) {
        url = "http\x3A\x2F\x2Fstaging.codebender.cc\x2Futilities\x2Flogdb\x2F38\x2FSAVEPORTMETA";
    ...
    this.initializePlugin = function()
    {
      ...
      {
        url = "http\x3A\x2F\x2Fstaging.codebender.cc\x2Futilities\x2Flogdb\x2F35\x2FPLUGIN_META";
    ...
    this.validateVersion = function(version)
    {
      ...
      if (this.comparePluginVersions(this.parseVersionString(this.codebender_plugin.version), this.parseVersionString(minimumVersion)) < 0)
      {
        ...
        this.owner.setOperationOutput(alert);
        this.owner.eventManager.fire('plugin_notification', alert);
        url = "http\x3A\x2F\x2Fstaging.codebender.cc\x2Futilities\x2Flogdb\x2F27\x2FPLUGIN_META";
      ...
      } else if (this.codebender_plugin.version == null){
        var alert = this.browserSpecificPluginInstall("To program your Arduino from your browser, install the Codebender Plugin. ");
        this.owner.setOperationOutput(alert);
        this.owner.eventManager.fire('plugin_notification', alert);
        url = "http\x3A\x2F\x2Fstaging.codebender.cc\x2Futilities\x2Flogdb\x2F27\x2FPLUGIN_META";
    ...
    this.initializePluginPortsLogger = function()
    {
      ...
      window.PluginLoggingInterval = setInterval(function(){
        try
        {
          if(typeof(pl.codebender_plugin.probeUSB) === "undefined")
          {
            url = "http\x3A\x2F\x2Fstaging.codebender.cc\x2Futilities\x2Flogdb\x2F34\x2FPLUGIN_META";
          ...
          {
            if ((typeof pl.codebender_plugin.availablePorts === 'undefined')
                   ...
                   ||(oldPortsAvail.length > portsAvail.length || (oldPortsAvail.length == 1 && portsAvail.length == 1 && oldPortsAvail[0] != "" && portsAvail[0] == ""))))
            {
              ...
              var url = "http\x3A\x2F\x2Fstaging.codebender.cc\x2Futilities\x2Flogdb\x2F36\x2FPLUGIN_META";
            ...
            if (typeof(pl.codebender_plugin.getPorts) !== "undefined")
            {
              pl.codebender_plugin.getPorts(function (serialPortsAvail) {
                if (oldSerialPortsAvail != serialPortsAvail)
                {
                  ...
                  pl.codebender_plugin.probeUSB(function (result) {
                    ...
                    $.get(url);
                    var url = "http\x3A\x2F\x2Fstaging.codebender.cc\x2Futilities\x2Flogdb\x2F74\x2FPLUGIN_META";
    ...
    this.doflash = function(select, board, programmer, binary, flash_callback)
    {
      if (select == true && typeof board["upload"]["protocol"] !== 'undefined')
      {
        ...
        else
        {
          ...
          this.codebender_plugin.flash(this.portslist.options[this.portslist.selectedIndex].text, binary, board["upload"]["maximum_size"], board["upload"]["protocol"], disable_flushing, board["upload"]["speed"], board["build"]["mcu"], flash_callback);
        }
      }else
      {
        if(programmer === "")
        ...
        else
        {
          ...
          this.codebender_plugin.flashWithProgrammer(selectedPort, binary, board["upload"]["maximum_size"], programmer["protocol"], programmer["communication"], programmer["speed"], programmer["force"], programmer["delay"], board["build"]["mcu"],
                                                     flash_callback);
    ...
    this.browserSpecificPluginInstall = function(alert)
    {
      ...
      {
        alert+= '<a target="_blank" href = "http\x3A\x2F\x2Fstaging.codebender.cc\x2Fstatic\x2Fplugin" >Learn more.</a>';
      }
      else
      {
        ...
        {
          alert+= '<a onclick=\'compilerflasher.pluginHandler.addTo("Firefox", "\x2F\x2Fstaging.codebender.cc\x2Fcodebender.xpi")\' id="xpi-download-url" href = "javascript:void(0);" >Add to Firefox.</a>';
        }
      }
    ...
    {
      url = "http\x3A\x2F\x2Fstaging.codebender.cc\x2Futilities\x2Flogdb\x2F45\x2FADD_TO_META";
    ...
    this.getFire = function() {
      var pl = this;
      if(typeof this.codebender_plugin.getPorts !== 'undefined')
      {
        this.codebender_plugin.getPorts(function (currentPorts) {
          ...
          if (ports != pl.oldPorts) {
            ...
            for (var i = 0; i < portsAvail.length; i++) {
              if (portsAvail[i] != "") {
                pl.portslist.options[i] = new Option(portsAvail[i], portsAvail[i], true, false);
                pl.currentPorts.push(portsAvail[i]);
              }
            }
    ...
    this.connect = function() {
      ...
      if (this.connected == false) {
        var url = "http\x3A\x2F\x2Fstaging.codebender.cc\x2Futilities\x2Flogdb\x2F18\x2FSERIAL_MONITOR_META";
        ...
        if ($("#cb_cf_ports").val() != null && $("#cb_cf_ports").val() != "") {
          ...
          pl.codebender_plugin.serialRead(
            ...
            function (from, line){
              var url = "http\x3A\x2F\x2Fstaging.codebender.cc\x2Futilities\x2Flogdb\x2F69\x2FPLUGIN_SERIAL_MONITOR_RETVAL_META";
          ...
          if(typeof this.codebender_plugin.availablePorts !== 'undefined')
          {
            var ph = this;
            window.portValidatorInterval = setInterval(function ()
                                                       {
                                                         ph.codebender_plugin.availablePorts(function (ports) {
    ...
    this.disconnect = function(notified) {
      ...
      if (this.connected == true) {
        if(notified == false)
        {
          var url = "http\x3A\x2F\x2Fstaging.codebender.cc\x2Futilities\x2Flogdb\x2F59\x2FSERIAL_MONITOR_DISC_META";
        ...
        if(this.codebender_plugin.availablePorts !== 'undefined')
          clearInterval(window.portValidatorInterval);
        ...
        if(!notified)
        {
          this.codebender_plugin.serialMonitorSetStatus();
        }
      }
    }
    ...
    this.plugin_error_logger = function(from, msg, status){
      ...
      {
        var url = "http\x3A\x2F\x2Fstaging.codebender.cc\x2Futilities\x2Flogdb\x2F34\x2FPLUGIN_ERROR_META";
      ...
      {
        var url = "http\x3A\x2F\x2Fstaging.codebender.cc\x2Futilities\x2Flogdb\x2F55\x2FPLUGIN_WARNING_META";
  ...
  if($("select#cb_cf_boards").length > 0)
  {
    ...
    $.getJSON("http\x3A\x2F\x2Fstaging.codebender.cc\x2Fboard\x2Flistboards", function(data){boardsListCallback(data)});
  ...
  if($("select#cb_cf_programmers").length > 0)
  {
    ...
    $.getJSON("http\x3A\x2F\x2Fstaging.codebender.cc\x2Fboard\x2Fprogrammers", function (data)
              {
  ...
  this.saveBoard = function() {
    ...
    url = "http\x3A\x2F\x2Fstaging.codebender.cc\x2Futilities\x2Flogdb\x2F37\x2FSAVEBOARDMETA";
  ...
  this.saveProgrammer = function() {
    ...
    url = "http\x3A\x2F\x2Fstaging.codebender.cc\x2Futilities\x2Flogdb\x2F39\x2FSAVEPROGRAMMERMETA";
  ...
  this.clickedBoard = function()
  {
    ...
    url = "http\x3A\x2F\x2Fstaging.codebender.cc\x2Futilities\x2Flogdb\x2F42\x2FCLICK_BOARD_META";
  ...
  this.clickedProgrammer = function()
  {
    ...
    url = "http\x3A\x2F\x2Fstaging.codebender.cc\x2Futilities\x2Flogdb\x2F44\x2FCLICK_PROGRAMMER_META";
  ...
  this.flash_callback = function(from, progress) {
    ...
    var url = "http\x3A\x2F\x2Fstaging.codebender.cc\x2Futilities\x2Fflash\x2FERROR_CODE";
  ...
  this.getHex = function() {
    ...
    var cb = this;
    $.post("http\x3A\x2F\x2Fstaging.codebender.cc\x2Futilities\x2Fcompile\x2F", payload, function (data) {
      try{
  ...
  // Blacklists in Chrome the boards that need a programmer (until BabelFish implements them)
  ...
  this.usbflash = function()
  {
    ...
    url = "http\x3A\x2F\x2Fstaging.codebender.cc\x2Futilities\x2Flogdb\x2F40\x2FRUN_BUTTON_META";
    ...
    if (this.blackListBoard(this.selectedBoard.name)) {
      this.setOperationOutput("The selected device needs a programmer, which is not supported by the BabelFish extention yet.")
      this.eventManager.fire('flash_failed', "The selected device needs a programmer, which is not supported by the BabelFish extention yet.");
      return;
    }
  ...
  {
    url = "http\x3A\x2F\x2Fstaging.codebender.cc\x2Futilities\x2Flogdb\x2F41\x2FRUN_WITH_PROG_BUTTON_META";
  ...
  this.verify =  function() {
    ...
    var board = $("#cb_cf_boards option:selected").text();
    url = "http\x3A\x2F\x2Fstaging.codebender.cc\x2Futilities\x2Flogdb\x2F47\x2FVERIFY_META";
  ...
  this.burn_bootloader = function() {
    ...
    {
      var url = "http\x3A\x2F\x2Fstaging.codebender.cc\x2Futilities\x2Flogdb\x2F25\x2FUPLOAD_BOOTLOADER_META";
      ...
      {
        this.pluginHandler.codebender_plugin.saveToHex("");
      ...
      else
      {
        ...
        $.get("\x2Fbootloader\x2F" + this.selectedBoard['bootloader']['file'].replace(".hex", ".txt"))
          .success(function(data){
            cb.pluginHandler.codebender_plugin.saveToHex(data);
